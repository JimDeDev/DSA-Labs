...
public class ArraySorter<E extends Comparable>
{
   ...
   private static int COMPARES = -1;
   private static int SWAPS = -1;
   ...
   {  ArraySorter<Integer> sorter = new ArraySorter<Integer>();
      ...
      long time;
      Integer[] originalList = new Integer[LIST_SIZE];
      Integer[] list = new Integer[LIST_SIZE];
      for (int i = 0; i < LIST_SIZE; i++) {
         originalList[i] = rand.nextInt(50);
      }

      System.arraycopy(originalList, 0, list, 0, LIST_SIZE);
      COMPARES = 0;
      SWAPS = 0;
   ...
   public static void printResults(Integer[] list, long time) {
